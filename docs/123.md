...
用户单击发送按钮后，用户名和消息本身将转换为 JSON 格式并发送到服务器。
...
您可以在此处下载完整的[源代码和 Eclipse 项目](http://javatutorial.net/downloads/WebSocketsChat.zip "Web Sochets Chat source code download")。